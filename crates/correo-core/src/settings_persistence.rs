...
use correo_storage::current::{
    ...
    Lwt as StorageLwt, MqttVersion as StorageMqttVersion, PluginStateSettings,
    Protocol as StorageProtocol, Proxy as StorageProxy, Qos as StorageQos, SecretKind,
    SecretMaterial, SecretReference, SecretStore, Settings, TlsSsl as StorageTlsSsl,
};
use thiserror::Error;
...
pub(crate) fn storage_connection(
    ...
    StorageConnectionConfig {
        ...
        lwt_qos: settings.lwt_enabled.then_some(StorageQos::AtMostOnce),
