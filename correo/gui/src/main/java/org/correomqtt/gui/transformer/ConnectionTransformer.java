...
public class ConnectionTransformer {
    ...
    public static ConnectionPropertiesDTO dtoToProps(ConnectionConfigDTO dto) {
        return ConnectionPropertiesDTO.builder()
                ...
                .sslHostVerification(dto.isSslHostVerification())
                .proxy(dto.getProxy())
    ...
    public static ConnectionConfigDTO propsToDto(ConnectionPropertiesDTO props) {
        return ConnectionConfigDTO.builder()
                ...
                .sslHostVerification(props.isSslHostVerification())
    ...
    public LwtConnectionExtensionDTO propsToLwtDTO(ConnectionPropertiesDTO connectionPropertiesDTO) {
        return LwtConnectionExtensionDTO.builder()
                .id(connectionPropertiesDTO.getId())
                .name(connectionPropertiesDTO.getName())
                .lwt(connectionPropertiesDTO.getLwt())
                .lwtTopic(connectionPropertiesDTO.getLwtTopic())
                .lwtQoS(connectionPropertiesDTO.getLwtQos())
                .lwtRetained(connectionPropertiesDTO.isLwtRetained())
                .lwtPayload(connectionPropertiesDTO.getLwtPayload())
                .customFields(new HashMap<>(connectionPropertiesDTO.getExtraProperties()))
                .build();
    }
}
