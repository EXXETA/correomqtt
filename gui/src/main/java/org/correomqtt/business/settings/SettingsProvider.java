...
public class SettingsProvider extends BaseUserFileProvider implements CoreSettings {
    ...
    @Override
    public boolean isInstallBundledPlugins() {
        return false;
    }

    @Override
    public String getBundledPluginsUrl() {
        return null;
    }
    ...
    @Override
    public boolean isUseDefaultRepo() {
        return false;
    }

    @Override
    public Map<String, String> getPluginRepositories() {
        return null;
    }
    ...
    public void saveConnections(List<ConnectionConfigDTO> connections, String masterPassword) throws EncryptionRecoverableException {
        ...
        ConnectionHolder.getInstance(this).refresh();
