...
public class CorreoApplication {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(CorreoApplication.class);
    ...
    @Inject
    public CorreoApplication(PluginManager pluginManager, PluginLauncher pluginLauncher, KeyringHandler keyringHandler) {
        this.pluginManager = pluginManager;
        this.pluginLauncher = pluginLauncher;
        this.keyringHandler = keyringHandler;
    }

    void init(HostServices hostServices) { //TODO inject somehow?
        ...
        setLocale(settings);
        HostServicesHolder.getInstance().setHostServices(hostServices);
