...
wget https://cdn.azul.com/zulu/bin/zulu13.29.9-ca-jdk13.0.2-macosx_x64.tar.gz
tar zxvf zulu13.29.9-ca-jdk13.0.2-macosx_x64.tar.gz
...
tar zxvf openjdk-14_osx-x64_bin.tar.gz