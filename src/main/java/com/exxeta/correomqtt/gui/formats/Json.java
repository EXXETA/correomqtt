package com.exxeta.correomqtt.gui.formats;
...
public class Json implements Format {
    ...
    private Object getParsedJsonObject() {
        if (jsonObject == null) {
            try {
                jsonObject = new ObjectMapper().readValue(text, Object.class);
            } catch (IOException e) {
    ...
    public String getPrettyString() {
        ...
        try {
            return new ObjectMapper().writerWithDefaultPrettyPrinter().writeValueAsString(getParsedJsonObject());
